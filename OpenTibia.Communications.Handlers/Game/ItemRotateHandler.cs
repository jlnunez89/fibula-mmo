...
namespace OpenTibia.Communications.Handlers.Game
{
    ...
    public class ItemRotateHandler : GameHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemRotateHandler"/> class.
        /// </summary>
        /// <param name="gameInstance">A reference to the game instance.</param>
        public ItemRotateHandler(IGame gameInstance)
            : base(gameInstance)
        {
        }
