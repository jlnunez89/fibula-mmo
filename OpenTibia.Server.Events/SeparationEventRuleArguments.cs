// -----------------------------------------------------------------
// <copyright file="SeparationEventRuleArguments.cs" company="2Dudes">
...
namespace OpenTibia.Server.Events
{
    ...
    /// </summary>
    public class SeparationEventRuleArguments : IEventRuleArguments
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SeparationEventRuleArguments"/> class.
        /// </summary>
        /// <param name="atLocation">The location of the separation.</param>
        ...
        public SeparationEventRuleArguments(Location atLocation, IThing thingMoving, ICreature requestingCreature = null)
        {
