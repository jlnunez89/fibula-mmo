...
namespace OpenTibia.Server.MovementEvents.EventConditions
{
    ...
    /// </summary>
    internal class AttackingCorrectTargetEventCondition : IEventCondition
    {
        /// <summary>
        ...
        public bool Evaluate()
        {
            ...
            return this.Attacker.AutoAttackTargetId > 0 && this.Attacker.AutoAttackTargetId == this.LastKnownTargetId;
        }
    }
}