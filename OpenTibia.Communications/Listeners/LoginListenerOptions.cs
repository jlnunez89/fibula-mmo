// -----------------------------------------------------------------
// <copyright file="LoginListenerOptions.cs" company="2Dudes">
...
namespace OpenTibia.Communications
{
    ...
    /// </summary>
    public class LoginListenerOptions : BaseListenerOptions
    {
        /// <summary>
        /// Gets or sets the client version.
        /// </summary>
        [Required(ErrorMessage = "A client version for the login listener must be speficied.")]
        public ProtocolVersion ClientVersion { get; set; }

        /// <summary>
        /// Gets or sets the IP address to listen to.
        /// </summary>
        [Required(ErrorMessage = "A public IP address for the login listener must be speficied.")]
        public string IpAddress { get; set; }

        /// <summary>
        /// Gets or sets the port to listen to.
        /// </summary>
        [Required(ErrorMessage = "A port for the login listener must be speficied.")]
