...
namespace Fibula.Server.Protocol.V772.RequestHandlers
{
    ...
    public class WalkNortheastHandler : WalkOnDemandHandler
    {
        ...
        public WalkNortheastHandler(ILogger logger, IGameContext gameContext)
            : base(logger, gameContext, Direction.NorthEast)
        {
        }
        ...
        /// </summary>
        public override byte ForRequestType => (byte)GameRequestType.WalkNorteast;
    }
}