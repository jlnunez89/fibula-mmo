...
namespace OpenTibia.Server.Contracts.Abstractions
{
    ...
    public interface IPathFinder
    {
        ...
        IEnumerable<Direction> FindBetween(Location startLocation, Location targetLocation, out Location endLocation, int maxStepsCount = default, ICreature onBehalfOfCreature = null);
    }
}