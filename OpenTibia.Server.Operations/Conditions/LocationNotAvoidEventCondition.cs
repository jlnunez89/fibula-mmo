...
namespace OpenTibia.Server.Operations.Conditions
{
    ...
    /// </summary>
    public class LocationNotAvoidEventCondition : IEventCondition
    {
        /// <summary>
        ...
        public bool Evaluate()
        {
            ...
            return !(thing is ICreature creature) || this.Requestor == creature || (this.TileAccessor.GetTileAt(this.GetLocation(), out ITile destTile) && !destTile.IsPathBlocking(/*this.Requestor.DamageTypesToAvoid*/));
        }
    }
}