...
namespace OpenTibia.Security.Encryption
{
    public static class Rsa
    {
        ...
        static BigInteger _otServerD = new BigInteger("", 10);
        ...
        static BigInteger _cipM = new BigInteger("", 10);
        ...
        static BigInteger _cipN;
        static BigInteger _cipD;
        static BigInteger _cipP1;
        static BigInteger _cipQ1;
        static BigInteger _cipPq1;
        static BigInteger _cipDp;
        static BigInteger _cipDq;
        static BigInteger _cipInverseQ;
            ...
            get
            {
                if (_cipInverseQ == null)
                {
                    lock (CipInverseQLock)
                    {
                        if (_cipInverseQ == null)
                        {
                            _cipInverseQ = CipQ.ModInverse(CipP);
                        }
                    }
                }
