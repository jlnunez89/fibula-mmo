// -----------------------------------------------------------------
// <copyright file="SeparationEventRule.cs" company="2Dudes">
...
namespace OpenTibia.Server.Events.MoveUseFile.EventRules
{
    ...
    /// </summary>
    internal class SeparationEventRule : MoveUseEventRule, ISeparationEventRule
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SeparationEventRule"/> class.
        /// </summary>
        ...
        public SeparationEventRule(ILogger logger, IScriptApi scriptFactory, IList<string> conditionSet, IList<string> actionSet)
