...
namespace Fibula.Server.Protocol.V772
{
    ...
    using Fibula.Server.Protocol.V772.PacketReaders;
    using Fibula.Server.Protocol.V772.PacketWriters;
    ...
    public static class ConfigurationRootExtensions
    {
        ...
        public static void AddProtocol772GameComponents(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSingleton(s =>
            {
                ...
                protocol.RegisterPacketReader((byte)IncomingGamePacketType.LogIn, s.GetRequiredService<GameLogInPacketReader>());
