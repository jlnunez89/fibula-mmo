...
namespace OpenTibia.Server.Items
{
    public class Item : Thing, IItem
    {
        ...
        public override string InspectionText // TODO: implement correctly.
            => $"{Type.Name}{(string.IsNullOrWhiteSpace(Type.Description) ? "" : "\n" + Type.Description)}";

        public override string CloseInspectionText => InspectionText;

        public uint HolderId => _holder;
        ...
        {
            var oldHolder = _holder;
            _holder = holder?.CreatureId ?? 0;
