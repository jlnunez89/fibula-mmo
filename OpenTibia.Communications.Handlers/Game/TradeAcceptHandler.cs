...
namespace OpenTibia.Communications.Handlers.Game
{
    ...
    public class TradeAcceptHandler : GameHandler
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TradeAcceptHandler"/> class.
        /// </summary>
        /// <param name="gameInstance">A reference to the game instance.</param>
        public TradeAcceptHandler(IGame gameInstance)
            : base(gameInstance)
        {
        }
        ...
        /// </summary>
        public override byte ForPacketType => (byte)IncomingGamePacketType.TradeAccept;
