...
namespace Fibula.Server.Protocol.V772.RequestHandlers
{
    ...
    public class WalkSoutheastHandler : WalkOnDemandHandler
    {
        ...
        public WalkSoutheastHandler(ILogger logger, IGameContext gameContext)
            : base(logger, gameContext, Direction.SouthEast)
        {
        }
        ...
        /// </summary>
        public override byte ForRequestType => (byte)GameRequestType.WalkSoutheast;
    }
}