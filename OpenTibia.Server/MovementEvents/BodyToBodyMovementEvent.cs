// -----------------------------------------------------------------
// <copyright file="BodyToBodyMovementEvent.cs" company="2Dudes">
...
namespace OpenTibia.Server.MovementEvents
{
    ...
    /// <summary>
    /// Internal class that represents a movement event that happens from and to a player's inventory.
    /// </summary>
    internal class BodyToBodyMovementEvent : BaseMovementEvent
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BodyToBodyMovementEvent"/> class.
        /// </summary>
        ...
        public BodyToBodyMovementEvent(
            ILogger logger,
            IGame game,
            ...
            : base(logger, game, connectionManager, creatureFinder, creatureRequestingId, evaluationTime)
        {
            ...
            var onPassAction = new GenericEventAction(() =>
            {
                bool moveSuccessful = thingMoving is IItem item &&
                                      ...
                                      this.Game.PerformItemMovement(item, targetPlayer.Inventory[fromCreatureSlot] as IContainerItem, targetPlayer.Inventory[toCreatureSlot] as IContainerItem, 0, 0, amount);
