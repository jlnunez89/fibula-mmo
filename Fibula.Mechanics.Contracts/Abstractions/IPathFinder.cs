...
namespace Fibula.Mechanics.Contracts.Abstractions
{
    ...
    public interface IPathFinder
    {
        ...
        public (SearchState result, Location endLocation, IEnumerable<Direction> directions) FindBetween(Location startLocation, Location targetLocation, ICreature onBehalfOfCreature = null, int maxStepsCount = default, bool considerAvoidsAsBlocking = true, int targetDistance = 1);
    }
}
